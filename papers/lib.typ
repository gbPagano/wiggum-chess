...
#let ieee(
    ...
    set text(font: "Times New Roman", size: 10pt, lang: "pt", region: "br")
    ...
    // Code blocks
    show raw: set text(font: "Jetbrains Mono", ligatures: false, size: 8pt)
    ...
    place(
        ...
        {
        v(3pt, weak: true)
        align(center, par(leading: 1em, text(size: 23pt, title)))
        v(8.35mm, weak: true)
    ...
    set par(spacing: 1em, justify: true, first-line-indent: 0em, leading: 0.4em)
